...
void V3Layer::createLayer(TGeoVolume *motherVolume)
{
  ...
  TGeoVolume *stavVol = createStave(phi);
...
TGeoVolume *V3Layer::createStave(Double_t phi,const TGeoManager * /*mgr*/)
{
//
...
//
  ...
  TGeoVolume *modVol = createStaveInnerB();
    ...
    TGeoVolume *hstaveVol = createStaveOuterB(phi);
...
TGeoVolume *V3Layer::createStaveOuterB(Double_t phi,const TGeoManager *mgr)
{
...
//
  ...
  switch (mStaveModel) {
    case Detector::kOBModelDummy:
      mechStavVol = createStaveModelOuterBDummy(phi,mgr);
      break;
    ...
    case Detector::kOBModel2:
      mechStavVol = createStaveModelOuterB2(phi,mgr);
      break;
    default:
      LOG(FATAL) << "Unknown stave model " << mStaveModel << FairLogger::endl;
      break;
...
TGeoVolume *V3Layer::createStaveModelOuterBDummy(Double_t phi,const TGeoManager *) const
{
//
// Create dummy stave
//
...
TGeoVolume *V3Layer::createStaveModelOuterB2(Double_t phi,const TGeoManager *mgr)
{
//
...
//   halfStaveVol->SetVisibility(kTRUE);
 ...
 LOG(INFO)<<Form("xPosS %f",xposS)<<FairLogger::endl;
  ...
  //    yposS=0;
    ...
    halfStaveVol->AddNode(moduleVol, j, new TGeoCombiTrans(xposS, yposS, zpos,
							   new TGeoRotation("",0,dtht,0)));
  ...
  for(Int_t k=0; k<sOBChipsPerRow; k++)   //put 7x2 chip into one module
    {
      ...
      new TGeoCombiTrans(-xpos, ypos, zpos, new TGeoRotation("",0,180,0)));
      mHierarchy[kChip]+=2;
    }
